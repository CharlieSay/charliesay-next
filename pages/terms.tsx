  ...
  return (
    <NvContainerFixedWide>
      ...
      <CopyLite>
        ...
        of Talesoft Digital&apos;s Website, located at charliesay.xyz.
      </CopyLite>

      <CopyLite>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use CharlieSay if you do not agree to
      ...
      <TitleH2>Cookies</TitleH2>

      <CopyLite>
        We employ the use of cookies. By accessing CharlieSay, you agreed to use
        cookies in agreement with the Talesoft Digital&apos;s Privacy Policy.
      </CopyLite>
      ...
      <TitleH2>License</TitleH2>

      <CopyLite>
        Unless otherwise stated, Talesoft Digital and/or its licensors own the
        intellectual property rights for all material on CharlieSay. All
        intellectual property rights are reserved. You may access this from
        CharlieSay for your own personal use subjected to restrictions set in
        these terms and conditions.
      </CopyLite>

      <CopyLite>You must not:</CopyLite>
      <UL>
        <LI>Republish material from CharlieSay</LI>
        <LI>Sell, rent or sub-license material from CharlieSay</LI>
        <LI>Reproduce, duplicate or copy material from CharlieSay</LI>
        <LI>Redistribute content from CharlieSay</LI>
      </UL>
      ...
      <CopyLite>
        ...
        Talesoft Digital does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Talesoft Digital,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Talesoft Digital
      ...
      <CopyLite>
        Talesoft Digital reserves the right to monitor all Comments and to
        remove any Comments which can be considered inappropriate, offensive or
        causes breach of these Terms and Conditions.
      </CopyLite>

      <CopyLite>You warrant and represent that:</CopyLite>
      ...
      <UL>
        ...
        <LI>Any dev blog, organisation, tweet etc;</LI>
        <LI>
      ...
      <CopyLite>
        ...
        the hyperlink compensates the absence of Talesoft Digital; and (d) the
      ...
      <CopyLite>
        ...
        e-mail to Talesoft Digital. Please include your name, your organization
      ...
      <CopyLite>
        No use of Talesoft Digital&apos;s logo or other artwork will be allowed
        for linking absent a trademark license agreement.
      </CopyLite>

      <TitleH2>iFrames</TitleH2>
      ...
      <TitleH2>Content Liability</TitleH2>
      ...
      <TitleH2>Your Privacy</TitleH2>

      <CopyLite>Please read Privacy Policy</CopyLite>

      <TitleH2>Reservation of Rights</TitleH2>
      ...
      <TitleH2>Removal of links from our website</TitleH2>
